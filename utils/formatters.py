...
class MessageFormatters:
    ...
    def format_welcome() -> str:
        ...
        return (
            "🏗️ ДОБРО ПОЖАЛОВАТЬ В ГОФРОБОТ!\n\n"
            "Этот бот поможет тебе развивать свою гофрошку и кабель.\n\n"
            "Доступные команды:\n"
            "/start - Начать игру\n"
            "/profile - Показать профиль\n"
            "/davka - Давить змия\n"
            "/uletet - Отправить змия в коричневую страну\n"
            "/rademka - Радёмка с другим игроком\n"
            "/top - Таблица лидеров\n"
            "/timing - Точные таймеры\n"
            "/help - Помощь\n"
